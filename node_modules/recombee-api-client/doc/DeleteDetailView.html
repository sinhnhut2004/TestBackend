...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteDetailView</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteDetailView</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteDetailView<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deletes an existing detail view uniquely specified by (`userId`, `itemId`, and `timestamp`) or all the detail views with given `userId` and `itemId` if `timestamp` is omitted.</div>
...
<article>
    ...
    <h4 class="name" id="DeleteDetailView"><span class="type-signature"></span>new DeleteDetailView<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user who made the detail view.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item of which the details were viewed.</td>
        </tr>
...
- Allowed parameters:
    - *timestamp*
        - Type: number
        - Description: Unix timestamp of the detail view. If the `timestamp` is omitted, then all the detail views with given `userId` and `itemId` are deleted.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-detail-view.js.html">requests/delete-detail-view.js</a>, <a href="requests_delete-detail-view.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-detail-view.js.html">requests/delete-detail-view.js</a>, <a href="requests_delete-detail-view.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-detail-view.js.html">requests/delete-detail-view.js</a>, <a href="requests_delete-detail-view.js.html#line45">line 45</a>
    </li></ul></dd>
