...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListItemBookmarks</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListItemBookmarks</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ListItemBookmarks<span class="signature">(itemId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">List all the ever-made bookmarks of a given item.</div>
...
<article>
    ...
    <h4 class="name" id="ListItemBookmarks"><span class="type-signature"></span>new ListItemBookmarks<span class="signature">(itemId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item of which the bookmarks are to be listed.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-item-bookmarks.js.html">requests/list-item-bookmarks.js</a>, <a href="requests_list-item-bookmarks.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-item-bookmarks.js.html">requests/list-item-bookmarks.js</a>, <a href="requests_list-item-bookmarks.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-item-bookmarks.js.html">requests/list-item-bookmarks.js</a>, <a href="requests_list-item-bookmarks.js.html#line36">line 36</a>
    </li></ul></dd>
