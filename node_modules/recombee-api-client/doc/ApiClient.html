...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ApiClient<span class="signature">(databaseId, secretToken, options)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="ApiClient"><span class="type-signature"></span>new ApiClient<span class="signature">(databaseId, secretToken, options)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Corresponding secret token</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api-client.js.html">api-client.js</a>, <a href="api-client.js.html#line13">line 13</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="api-client.js.html">api-client.js</a>, <a href="api-client.js.html#line37">line 37</a>
    </li></ul></dd>
