...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: UpdateMoreItems</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: UpdateMoreItems</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>UpdateMoreItems<span class="signature">(filter, changes)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Update (some) property values of all the items that pass the filter.
...
<article>
    ...
    <h4 class="name" id="UpdateMoreItems"><span class="type-signature"></span>new UpdateMoreItems<span class="signature">(filter, changes)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">A [ReQL](https://docs.recombee.com/reql.html) expression, which return `true` for the items that shall be updated.</td>
        </tr>
        ...
        <tr>
            ...
            <td class="description last">A dictionary where the keys are properties which shall be updated.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_update-more-items.js.html">requests/update-more-items.js</a>, <a href="requests_update-more-items.js.html#line18">line 18</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_update-more-items.js.html">requests/update-more-items.js</a>, <a href="requests_update-more-items.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_update-more-items.js.html">requests/update-more-items.js</a>, <a href="requests_update-more-items.js.html#line47">line 47</a>
    </li></ul></dd>
