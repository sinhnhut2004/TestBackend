...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AddItemProperty</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AddItemProperty</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>AddItemProperty<span class="signature">(propertyName, type)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Adding an item property is somehow equivalent to adding a column to the table of items. The items may be characterized by various properties of different types.</div>
...
<article>
    ...
    <h4 class="name" id="AddItemProperty"><span class="type-signature"></span>new AddItemProperty<span class="signature">(propertyName, type)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Name of the item property to be created. Currently, the following names are reserved:`id`, `itemid`, case insensitively. Also, the length of the property name must not exceed 63 characters.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_add-item-property.js.html">requests/add-item-property.js</a>, <a href="requests_add-item-property.js.html#line11">line 11</a>
    </li></ul></dd>
