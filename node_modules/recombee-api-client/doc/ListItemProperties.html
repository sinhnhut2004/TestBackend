...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListItemProperties</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListItemProperties</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ListItemProperties<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Gets the list of all the item properties in your database.</div>
...
<article>
    ...
    <h4 class="name" id="ListItemProperties"><span class="type-signature"></span>new ListItemProperties<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-item-properties.js.html">requests/list-item-properties.js</a>, <a href="requests_list-item-properties.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-item-properties.js.html">requests/list-item-properties.js</a>, <a href="requests_list-item-properties.js.html#line24">line 24</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-item-properties.js.html">requests/list-item-properties.js</a>, <a href="requests_list-item-properties.js.html#line34">line 34</a>
    </li></ul></dd>
