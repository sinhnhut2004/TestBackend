...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListUserRatings</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListUserRatings</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ListUserRatings<span class="signature">(userId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">List all the ratings ever submitted by a given user.</div>
...
<article>
    ...
    <h4 class="name" id="ListUserRatings"><span class="type-signature"></span>new ListUserRatings<span class="signature">(userId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user whose ratings are to be listed.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-ratings.js.html">requests/list-user-ratings.js</a>, <a href="requests_list-user-ratings.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-ratings.js.html">requests/list-user-ratings.js</a>, <a href="requests_list-user-ratings.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-ratings.js.html">requests/list-user-ratings.js</a>, <a href="requests_list-user-ratings.js.html#line36">line 36</a>
    </li></ul></dd>
