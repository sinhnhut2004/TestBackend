...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteUserProperty</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteUserProperty</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteUserProperty<span class="signature">(propertyName)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deleting an user property is roughly equivalent to removing a column from the table of users.</div>
...
<article>
    ...
    <h4 class="name" id="DeleteUserProperty"><span class="type-signature"></span>new DeleteUserProperty<span class="signature">(propertyName)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-user-property.js.html">requests/delete-user-property.js</a>, <a href="requests_delete-user-property.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-user-property.js.html">requests/delete-user-property.js</a>, <a href="requests_delete-user-property.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-user-property.js.html">requests/delete-user-property.js</a>, <a href="requests_delete-user-property.js.html#line36">line 36</a>
    </li></ul></dd>
