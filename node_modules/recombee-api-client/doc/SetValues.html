...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SetValues</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SetValues</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SetValues<span class="signature">(values, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Set/update (some) property values of a given entity.</div>
...
<article>
    ...
    <h4 class="name" id="SetValues"><span class="type-signature"></span>new SetValues<span class="signature">(values, optional)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_set-values.js.html">requests/set-values.js</a>, <a href="requests_set-values.js.html#line7">line 7</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_set-values.js.html">requests/set-values.js</a>, <a href="requests_set-values.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_set-values.js.html">requests/set-values.js</a>, <a href="requests_set-values.js.html#line46">line 46</a>
    </li></ul></dd>
