...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ResponseError<span class="signature">(request, statusCode, message)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Error thrown when a request did not succeed (did not return 200 or 201)</div>
...
<article>
    ...
    <h4 class="name" id="ResponseError"><span class="type-signature"></span>new ResponseError<span class="signature">(request, statusCode, message)</span><span class="type-signature"></span></h4>
...
<span class="param-type">number</span>
            ...
            <td class="description last">The returned status code</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Error message from the API</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="errors_response-error.js.html">errors/response-error.js</a>, <a href="errors_response-error.js.html#line7">line 7</a>
    </li></ul></dd>
