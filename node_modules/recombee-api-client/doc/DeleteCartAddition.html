...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteCartAddition</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteCartAddition</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteCartAddition<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deletes an existing cart addition uniquely specified by `userId`, `itemId`, and `timestamp` or all the cart additions with given `userId` and `itemId` if `timestamp` is omitted.</div>
...
<article>
    ...
    <h4 class="name" id="DeleteCartAddition"><span class="type-signature"></span>new DeleteCartAddition<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user who made the cart addition.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item of which was added to cart.</td>
        </tr>
...
- Allowed parameters:
    - *timestamp*
        - Type: number
        - Description: Unix timestamp of the cart addition. If the `timestamp` is omitted, then all the cart additions with given `userId` and `itemId` are deleted.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-cart-addition.js.html">requests/delete-cart-addition.js</a>, <a href="requests_delete-cart-addition.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-cart-addition.js.html">requests/delete-cart-addition.js</a>, <a href="requests_delete-cart-addition.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-cart-addition.js.html">requests/delete-cart-addition.js</a>, <a href="requests_delete-cart-addition.js.html#line45">line 45</a>
    </li></ul></dd>
