...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteBookmark</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteBookmark</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteBookmark<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deletes a bookmark uniquely specified by `userId`, `itemId`, and `timestamp` or all the bookmarks with given `userId` and `itemId` if `timestamp` is omitted.</div>
...
<article>
    ...
    <h4 class="name" id="DeleteBookmark"><span class="type-signature"></span>new DeleteBookmark<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user who made the bookmark.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item of which was bookmarked.</td>
        </tr>
...
- Allowed parameters:
    - *timestamp*
        - Type: number
        - Description: Unix timestamp of the bookmark. If the `timestamp` is omitted, then all the bookmarks with given `userId` and `itemId` are deleted.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-bookmark.js.html">requests/delete-bookmark.js</a>, <a href="requests_delete-bookmark.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-bookmark.js.html">requests/delete-bookmark.js</a>, <a href="requests_delete-bookmark.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-bookmark.js.html">requests/delete-bookmark.js</a>, <a href="requests_delete-bookmark.js.html#line45">line 45</a>
    </li></ul></dd>
