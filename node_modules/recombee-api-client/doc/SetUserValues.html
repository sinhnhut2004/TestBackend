...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SetUserValues</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SetUserValues</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SetUserValues<span class="signature">(userId, values, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Set/update (some) property values of a given user. The properties (columns) must be previously created by [Add user property](https://docs.recombee.com/api.html#add-user-property).</div>
...
<article>
    ...
    <h4 class="name" id="SetUserValues"><span class="type-signature"></span>new SetUserValues<span class="signature">(userId, values, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user which will be modified.</td>
        </tr>
...
- Allowed parameters:
    - *cascadeCreate*
        - Type: boolean
        - Description: Sets whether the user should be created  if not present in the database.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_set-user-values.js.html">requests/set-user-values.js</a>, <a href="requests_set-user-values.js.html#line7">line 7</a>
    </li></ul></dd>
