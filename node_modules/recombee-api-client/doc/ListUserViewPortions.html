...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListUserViewPortions</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListUserViewPortions</h1>
...
<article>
    ...
    <h4 class="name" id="ListUserViewPortions"><span class="type-signature"></span>new ListUserViewPortions<span class="signature">(userId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user whose view portions are to be listed.</td>
        </tr>
