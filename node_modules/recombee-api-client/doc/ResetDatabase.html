...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ResetDatabase</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ResetDatabase</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ResetDatabase<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Completely erases all your data, including items, item properties, series, user database, purchases, ratings, detail views, and bookmarks. Make sure the request to be never executed in production environment! Resetting your database is irreversible.</div>
...
<article>
    ...
    <h4 class="name" id="ResetDatabase"><span class="type-signature"></span>new ResetDatabase<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_reset-database.js.html">requests/reset-database.js</a>, <a href="requests_reset-database.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_reset-database.js.html">requests/reset-database.js</a>, <a href="requests_reset-database.js.html#line24">line 24</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_reset-database.js.html">requests/reset-database.js</a>, <a href="requests_reset-database.js.html#line34">line 34</a>
    </li></ul></dd>
