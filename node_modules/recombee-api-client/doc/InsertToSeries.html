...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: InsertToSeries</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: InsertToSeries</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>InsertToSeries<span class="signature">(seriesId, itemType, itemId, time, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Inserts an existing item/series into series of given seriesId at position determined by time.</div>
...
<article>
    ...
    <h4 class="name" id="InsertToSeries"><span class="type-signature"></span>new InsertToSeries<span class="signature">(seriesId, itemType, itemId, time, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the series to be inserted into.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">`item` iff the regular item from the catalog is to be inserted, `series` iff series is inserted as the item.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item iff `itemType` is `item`. ID of the series iff `itemType` is `series`.</td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last">Time index used for sorting items in the series. According to time, items are sorted within series in ascending order. In the example of TV show episodes, the episode number is a natural choice to be passed as time.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_insert-to-series.js.html">requests/insert-to-series.js</a>, <a href="requests_insert-to-series.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_insert-to-series.js.html">requests/insert-to-series.js</a>, <a href="requests_insert-to-series.js.html#line39">line 39</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_insert-to-series.js.html">requests/insert-to-series.js</a>, <a href="requests_insert-to-series.js.html#line55">line 55</a>
    </li></ul></dd>
