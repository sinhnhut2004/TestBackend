...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListSeriesItems</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListSeriesItems</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ListSeriesItems<span class="signature">(seriesId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">List all the items present in the given series, sorted according to their time index values.</div>
...
<article>
    ...
    <h4 class="name" id="ListSeriesItems"><span class="type-signature"></span>new ListSeriesItems<span class="signature">(seriesId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the series items of which are to be listed.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-series-items.js.html">requests/list-series-items.js</a>, <a href="requests_list-series-items.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-series-items.js.html">requests/list-series-items.js</a>, <a href="requests_list-series-items.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-series-items.js.html">requests/list-series-items.js</a>, <a href="requests_list-series-items.js.html#line36">line 36</a>
    </li></ul></dd>
