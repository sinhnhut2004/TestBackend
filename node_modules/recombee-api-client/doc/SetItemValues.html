...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SetItemValues</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SetItemValues</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>SetItemValues<span class="signature">(itemId, values, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Set/update (some) property values of a given item. The properties (columns) must be previously created by [Add item property](https://docs.recombee.com/api.html#add-item-property).</div>
...
<article>
    ...
    <h4 class="name" id="SetItemValues"><span class="type-signature"></span>new SetItemValues<span class="signature">(itemId, values, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item which will be modified.</td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last">The values for the individual properties.
  {
...
- Allowed parameters:
    - *cascadeCreate*
        - Type: boolean
        - Description: Sets whether the item should be created if not present in the database.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_set-item-values.js.html">requests/set-item-values.js</a>, <a href="requests_set-item-values.js.html#line7">line 7</a>
    </li></ul></dd>
