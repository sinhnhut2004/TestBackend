...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: InsertToGroup</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: InsertToGroup</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>InsertToGroup<span class="signature">(groupId, itemType, itemId, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Inserts an existing item/group into group of given `groupId`.</div>
...
<article>
    ...
    <h4 class="name" id="InsertToGroup"><span class="type-signature"></span>new InsertToGroup<span class="signature">(groupId, itemType, itemId, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the group to be inserted into.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">`item` iff the regular item from the catalog is to be inserted, `group` iff group is inserted as the item.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item iff `itemType` is `item`. ID of the group iff `itemType` is `group`.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_insert-to-group.js.html">requests/insert-to-group.js</a>, <a href="requests_insert-to-group.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_insert-to-group.js.html">requests/insert-to-group.js</a>, <a href="requests_insert-to-group.js.html#line37">line 37</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_insert-to-group.js.html">requests/insert-to-group.js</a>, <a href="requests_insert-to-group.js.html#line52">line 52</a>
    </li></ul></dd>
