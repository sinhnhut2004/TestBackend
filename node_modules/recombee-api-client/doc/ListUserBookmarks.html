...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListUserBookmarks</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListUserBookmarks</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ListUserBookmarks<span class="signature">(userId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">List all the bookmarks ever made by a given user.</div>
...
<article>
    ...
    <h4 class="name" id="ListUserBookmarks"><span class="type-signature"></span>new ListUserBookmarks<span class="signature">(userId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user whose bookmarks are to be listed.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-bookmarks.js.html">requests/list-user-bookmarks.js</a>, <a href="requests_list-user-bookmarks.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-bookmarks.js.html">requests/list-user-bookmarks.js</a>, <a href="requests_list-user-bookmarks.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-bookmarks.js.html">requests/list-user-bookmarks.js</a>, <a href="requests_list-user-bookmarks.js.html#line36">line 36</a>
    </li></ul></dd>
