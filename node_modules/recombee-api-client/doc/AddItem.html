...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AddItem</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AddItem</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>AddItem<span class="signature">(itemId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Adds new item of given `itemId` to the items catalog.
All the item properties for the newly created items are set null.</div>
...
<article>
    ...
    <h4 class="name" id="AddItem"><span class="type-signature"></span>new AddItem<span class="signature">(itemId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item to be created.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_add-item.js.html">requests/add-item.js</a>, <a href="requests_add-item.js.html#line12">line 12</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_add-item.js.html">requests/add-item.js</a>, <a href="requests_add-item.js.html#line27">line 27</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_add-item.js.html">requests/add-item.js</a>, <a href="requests_add-item.js.html#line37">line 37</a>
    </li></ul></dd>
