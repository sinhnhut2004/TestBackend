...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListSearchSynonyms</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListSearchSynonyms</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ListSearchSynonyms<span class="signature">(optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Gives the list of synonyms defined in the database.</div>
...
<article>
    ...
    <h4 class="name" id="ListSearchSynonyms"><span class="type-signature"></span>new ListSearchSynonyms<span class="signature">(optional)</span><span class="type-signature"></span></h4>
...
- Allowed parameters:
    ...
    - *offset*
        - Type: number
        - Description: Specifies the number of synonyms to skip (ordered by `term`).</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-search-synonyms.js.html">requests/list-search-synonyms.js</a>, <a href="requests_list-search-synonyms.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-search-synonyms.js.html">requests/list-search-synonyms.js</a>, <a href="requests_list-search-synonyms.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-search-synonyms.js.html">requests/list-search-synonyms.js</a>, <a href="requests_list-search-synonyms.js.html#line45">line 45</a>
    </li></ul></dd>
