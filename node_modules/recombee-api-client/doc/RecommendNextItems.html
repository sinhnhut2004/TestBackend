...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: RecommendNextItems</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: RecommendNextItems</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>RecommendNextItems<span class="signature">(recommId, count)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Returns items that shall be shown to a user as next recommendations when the user e.g. scrolls the page down (*infinite scroll*) or goes to a next page.
...
For billing purposes, each call to *Recommend next items* is counted as a separate recommendation request.</div>
...
<article>
    ...
    <h4 class="name" id="RecommendNextItems"><span class="type-signature"></span>new RecommendNextItems<span class="signature">(recommId, count)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>recommId</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the base recommendation request for which next recommendations should be returned</td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last">Number of items to be recommended</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_recommend-next-items.js.html">requests/recommend-next-items.js</a>, <a href="requests_recommend-next-items.js.html#line21">line 21</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_recommend-next-items.js.html">requests/recommend-next-items.js</a>, <a href="requests_recommend-next-items.js.html#line38">line 38</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_recommend-next-items.js.html">requests/recommend-next-items.js</a>, <a href="requests_recommend-next-items.js.html#line49">line 49</a>
    </li></ul></dd>
