...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteViewPortion</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteViewPortion</h1>
...
<article>
    ...
    <h4 class="name" id="DeleteViewPortion"><span class="type-signature"></span>new DeleteViewPortion<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h4>
...
- Allowed parameters:
    - *sessionId*
        - Type: string
        - Description: Identifier of a session.</td>
        </tr>
