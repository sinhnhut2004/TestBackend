...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteItem</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteItem</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteItem<span class="signature">(itemId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deletes an item of given `itemId` from the catalog.
...
<article>
    ...
    <h4 class="name" id="DeleteItem"><span class="type-signature"></span>new DeleteItem<span class="signature">(itemId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item to be deleted.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-item.js.html">requests/delete-item.js</a>, <a href="requests_delete-item.js.html#line13">line 13</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-item.js.html">requests/delete-item.js</a>, <a href="requests_delete-item.js.html#line28">line 28</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-item.js.html">requests/delete-item.js</a>, <a href="requests_delete-item.js.html#line38">line 38</a>
    </li></ul></dd>
