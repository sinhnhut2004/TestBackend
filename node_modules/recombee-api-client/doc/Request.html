...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>Request<span class="signature">(method, path, timeout, ensureHttps)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Base class for all the requests</div>
...
<article>
    ...
    <h4 class="name" id="Request"><span class="type-signature"></span>new Request<span class="signature">(method, path, timeout, ensureHttps)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">GET/PUT/POST/DELETE</td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last">Timeout in milliseconds</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>ensureHttps</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">If true, always use HTTPS</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_request.js.html">requests/request.js</a>, <a href="requests_request.js.html#line6">line 6</a>
    </li></ul></dd>
