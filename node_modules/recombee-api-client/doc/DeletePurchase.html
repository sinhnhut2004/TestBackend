...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeletePurchase</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeletePurchase</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeletePurchase<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deletes an existing purchase uniquely specified by `userId`, `itemId`, and `timestamp` or all the purchases with given `userId` and `itemId` if `timestamp` is omitted.</div>
...
<article>
    ...
    <h4 class="name" id="DeletePurchase"><span class="type-signature"></span>new DeletePurchase<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user who made the purchase.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item of which was purchased.</td>
        </tr>
...
- Allowed parameters:
    - *timestamp*
        - Type: number
        - Description: Unix timestamp of the purchase. If the `timestamp` is omitted, then all the purchases with given `userId` and `itemId` are deleted.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-purchase.js.html">requests/delete-purchase.js</a>, <a href="requests_delete-purchase.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-purchase.js.html">requests/delete-purchase.js</a>, <a href="requests_delete-purchase.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-purchase.js.html">requests/delete-purchase.js</a>, <a href="requests_delete-purchase.js.html#line45">line 45</a>
    </li></ul></dd>
