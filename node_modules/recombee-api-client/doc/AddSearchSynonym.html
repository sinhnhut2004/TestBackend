...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: AddSearchSynonym</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: AddSearchSynonym</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>AddSearchSynonym<span class="signature">(term, synonym, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Adds a new synonym for the [Search items](https://docs.recombee.com/api.html#search-items).
...
An example of a synonym can be `science fiction` for the term `sci-fi`.</div>
...
<article>
    ...
    <h4 class="name" id="AddSearchSynonym"><span class="type-signature"></span>new AddSearchSynonym<span class="signature">(term, synonym, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">A word to which the `synonym` is specified.</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>synonym</code></td>
...
<span class="param-type">string</span>
            ...
            <td class="description last">A word that should be considered equal to the `term` by the full-text search engine.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_add-search-synonym.js.html">requests/add-search-synonym.js</a>, <a href="requests_add-search-synonym.js.html#line14">line 14</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_add-search-synonym.js.html">requests/add-search-synonym.js</a>, <a href="requests_add-search-synonym.js.html#line39">line 39</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_add-search-synonym.js.html">requests/add-search-synonym.js</a>, <a href="requests_add-search-synonym.js.html#line54">line 54</a>
    </li></ul></dd>
