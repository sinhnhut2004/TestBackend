...
Note that the status code of the batch request itself is 200 even if the individual requests result in error – you have to inspect the code values in the resulting array.</div>
...
<article>
    ...
    <h4 class="name" id="Batch"><span class="type-signature"></span>new Batch<span class="signature">(requests, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">Array.&lt;<a href="Request.html">Request</a>></span>
            ...
            <td class="description last">Array containing the requests.</td>
        </tr>
...
- Allowed parameters:
    - *distinctRecomms*
        - Type: boolean
        - Description: Makes all the recommended items for a certain user distinct among multiple recommendation requests in the batch.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_batch.js.html">requests/batch.js</a>, <a href="requests_batch.js.html#line13">line 13</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_batch.js.html">requests/batch.js</a>, <a href="requests_batch.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_batch.js.html">requests/batch.js</a>, <a href="requests_batch.js.html#line65">line 65</a>
    </li></ul></dd>
