...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListUserDetailViews</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListUserDetailViews</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ListUserDetailViews<span class="signature">(userId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Lists all the detail views of different items ever made by a given user.</div>
...
<article>
    ...
    <h4 class="name" id="ListUserDetailViews"><span class="type-signature"></span>new ListUserDetailViews<span class="signature">(userId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user whose detail views are to be listed.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-detail-views.js.html">requests/list-user-detail-views.js</a>, <a href="requests_list-user-detail-views.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-detail-views.js.html">requests/list-user-detail-views.js</a>, <a href="requests_list-user-detail-views.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-user-detail-views.js.html">requests/list-user-detail-views.js</a>, <a href="requests_list-user-detail-views.js.html#line36">line 36</a>
    </li></ul></dd>
