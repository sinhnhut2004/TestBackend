...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListItemViewPortions</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListItemViewPortions</h1>
...
<article>
    ...
    <h4 class="name" id="ListItemViewPortions"><span class="type-signature"></span>new ListItemViewPortions<span class="signature">(itemId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item of which the view portions are to be listed.</td>
        </tr>
