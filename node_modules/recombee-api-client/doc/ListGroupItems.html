...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ListGroupItems</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ListGroupItems</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ListGroupItems<span class="signature">(groupId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">List all the items present in the given group.</div>
...
<article>
    ...
    <h4 class="name" id="ListGroupItems"><span class="type-signature"></span>new ListGroupItems<span class="signature">(groupId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the group items of which are to be listed.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-group-items.js.html">requests/list-group-items.js</a>, <a href="requests_list-group-items.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-group-items.js.html">requests/list-group-items.js</a>, <a href="requests_list-group-items.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_list-group-items.js.html">requests/list-group-items.js</a>, <a href="requests_list-group-items.js.html#line36">line 36</a>
    </li></ul></dd>
