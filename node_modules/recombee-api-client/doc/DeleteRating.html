...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteRating</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteRating</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteRating<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deletes an existing rating specified by (`userId`, `itemId`, `timestamp`) from the database or all the ratings with given `userId` and `itemId` if `timestamp` is omitted.</div>
...
<article>
    ...
    <h4 class="name" id="DeleteRating"><span class="type-signature"></span>new DeleteRating<span class="signature">(userId, itemId, optional)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user who rated the item.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the item which was rated.</td>
        </tr>
...
- Allowed parameters:
    - *timestamp*
        - Type: number
        - Description: Unix timestamp of the rating. If the `timestamp` is omitted, then all the ratings with given `userId` and `itemId` are deleted.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-rating.js.html">requests/delete-rating.js</a>, <a href="requests_delete-rating.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-rating.js.html">requests/delete-rating.js</a>, <a href="requests_delete-rating.js.html#line35">line 35</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-rating.js.html">requests/delete-rating.js</a>, <a href="requests_delete-rating.js.html#line45">line 45</a>
    </li></ul></dd>
