...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteUser</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteUser</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteUser<span class="signature">(userId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deletes a user of given *userId* from the database.
If there are any purchases, ratings, bookmarks, cart additions or detail views made by the user present in the database, they will be deleted in cascade as well.</div>
...
<article>
    ...
    <h4 class="name" id="DeleteUser"><span class="type-signature"></span>new DeleteUser<span class="signature">(userId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user to be deleted.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-user.js.html">requests/delete-user.js</a>, <a href="requests_delete-user.js.html#line12">line 12</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-user.js.html">requests/delete-user.js</a>, <a href="requests_delete-user.js.html#line27">line 27</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-user.js.html">requests/delete-user.js</a>, <a href="requests_delete-user.js.html#line37">line 37</a>
    </li></ul></dd>
