...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: DeleteSeries</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: DeleteSeries</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>DeleteSeries<span class="signature">(seriesId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Deletes the series of given `seriesId` from the database.
Deleting a series will only delete assignment of items to it, not the items themselves!</div>
...
<article>
    ...
    <h4 class="name" id="DeleteSeries"><span class="type-signature"></span>new DeleteSeries<span class="signature">(seriesId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the series to be deleted.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-series.js.html">requests/delete-series.js</a>, <a href="requests_delete-series.js.html#line12">line 12</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-series.js.html">requests/delete-series.js</a>, <a href="requests_delete-series.js.html#line27">line 27</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_delete-series.js.html">requests/delete-series.js</a>, <a href="requests_delete-series.js.html#line37">line 37</a>
    </li></ul></dd>
