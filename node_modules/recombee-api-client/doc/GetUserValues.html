...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: GetUserValues</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: GetUserValues</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>GetUserValues<span class="signature">(userId)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Get all the current property values of a given user.</div>
...
<article>
    ...
    <h4 class="name" id="GetUserValues"><span class="type-signature"></span>new GetUserValues<span class="signature">(userId)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the user properties of which are to be obtained.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_get-user-values.js.html">requests/get-user-values.js</a>, <a href="requests_get-user-values.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_get-user-values.js.html">requests/get-user-values.js</a>, <a href="requests_get-user-values.js.html#line26">line 26</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_get-user-values.js.html">requests/get-user-values.js</a>, <a href="requests_get-user-values.js.html#line36">line 36</a>
    </li></ul></dd>
