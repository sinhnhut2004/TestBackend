...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: RemoveFromSeries</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: RemoveFromSeries</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>RemoveFromSeries<span class="signature">(seriesId, itemType, itemId, time)</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Removes an existing series item from the series.</div>
...
<article>
    ...
    <h4 class="name" id="RemoveFromSeries"><span class="type-signature"></span>new RemoveFromSeries<span class="signature">(seriesId, itemType, itemId, time)</span><span class="type-signature"></span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last">ID of the series from which a series item is to be removed.</td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last">Type of the item to be removed.</td>
        </tr>
...
<span class="param-type">number</span>
            ...
            <td class="description last">Time index of the item to be removed.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_remove-from-series.js.html">requests/remove-from-series.js</a>, <a href="requests_remove-from-series.js.html#line11">line 11</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_remove-from-series.js.html">requests/remove-from-series.js</a>, <a href="requests_remove-from-series.js.html#line32">line 32</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="requests_remove-from-series.js.html">requests/remove-from-series.js</a>, <a href="requests_remove-from-series.js.html#line42">line 42</a>
    </li></ul></dd>
