...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ApiError</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ApiError</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ApiError<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description">Base class for errors that occur because of errors in requests reported by API or because of a timeout</div>
...
<article>
    ...
    <h4 class="name" id="ApiError"><span class="type-signature"></span>new ApiError<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="errors_api-error.js.html">errors/api-error.js</a>, <a href="errors_api-error.js.html#line8">line 8</a>
    </li></ul></dd>
